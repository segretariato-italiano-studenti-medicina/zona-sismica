...
if (have_posts()) : while (have_posts()) : the_post(); ?>
	<?php if (get_option('thestyle_blog_style') == 'false') { ?>
		...
		<div class="entry <?php if ($biglayout) echo('big'); else echo('small');?>">
			...
			<h2 class="title"><a href="<?php the_permalink(); ?>"><?php /*if ($biglayout) truncate_title(50); else truncate_title(20);*/ the_title(); ?></a></h2>
			<p class="postinfo"><?php  the_terms( $post->ID, 'autore', 'Di ', ' & ', '' ); ?></p>
			<div class="entry-content">
				<div class="bottom-bg">
					<div class="excerpt">
						<p><?php if ($biglayout) truncate_post(500); else truncate_post(230); ?></p>
						<div class="textright">
